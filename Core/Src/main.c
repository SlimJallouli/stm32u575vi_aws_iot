...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, MXCHIP_RESET_Pin|LED_BLUE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, MXCHIP_RESETD13_Pin|MXCHIP_NSS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : MXCHIP_RESET_Pin LED_BLUE_Pin */
  GPIO_InitStruct.Pin = MXCHIP_RESET_Pin|LED_BLUE_Pin;
  ...
  /*Configure GPIO pins : MXCHIP_RESETD13_Pin MXCHIP_NSS_Pin */
  GPIO_InitStruct.Pin = MXCHIP_RESETD13_Pin|MXCHIP_NSS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
